 ...
 *
 *
 * NOT ACTUALLY DO NOT REGENERATE
 * 
 * 
 */
...
#region Filter
            ...
            public class GetUserRatingsFilter : SearchFilter<GetUserRatingsFilter>
            {
                ...
                /// <summary>
                /// Set the resource type of the ratings you're getting from the api.
                /// </summary>
                /// <remarks>Accepted values are `mods` and `collections`.</remarks>
                public GetUserRatingsFilter ResourceType(ModioResourceType resourceType)
                {
                    Parameters["resource_type"] = resourceType.GetStringCode();
                    return this;
                }
            }
#endregion
