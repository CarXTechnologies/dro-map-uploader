...
namespace Editor
{
	...
	public class GameMarkerTemplateConfigDrawer : PropertyDrawer
	{
			...
			GUIContent label)
		{
			...
			amountRect.x -= 16;
			amountRect.width /= 3;
			propSelectHead.intValue = EditorGUI.Popup(amountRect,
				Mathf.Clamp(propSelectHead.intValue, 0, MarkerData.paramEditorOnlyParameters.Length - 1), MarkerData.paramEditorOnlyParameters);
		...
		private int GetIndexTemplate(string template, SerializedProperty property)
		{
